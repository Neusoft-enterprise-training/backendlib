package com.neusoft.hotel.Result;
...
public class Result<T> {
	...
	private T result = null;//接受返回的单个model类对象
	private List<T> list = null;//接受返回的多个model类对象
